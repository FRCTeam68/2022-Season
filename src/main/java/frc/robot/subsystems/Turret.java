...
public class Turret extends SubsystemBase{
    ...
    public Turret(){
        ...
        //soft limits
        turretMotor.configForwardSoftLimitThreshold(60000); //180-deg limit with ring gear 140, spur 10, gearbox 45, encoder 1024
        turretMotor.configReverseSoftLimitThreshold(-60000);
